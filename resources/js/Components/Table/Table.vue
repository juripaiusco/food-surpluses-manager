                    ...
                    <td class="align-middle"
                        ...
                        <template v-if="struct.btnEdit === true || struct.btnDel === true">
                            ...
                            <Link class="btn btn-sm"
                                  ...
                                  :data-bs-toggle="struct.btnDel === true ? 'modal' : ''"
                                  :data-bs-target="struct.btnDel === true ? '#deleteModal' : ''"
                                  :class="{
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5 font-semibold" id="deleteModalLabel">Elimina</h1>
                    ...
                    <div class="modal-footer">
                        <div class="inline-flex w-full">
                            <div class="w-1/2 mr-1">
                                <button type="button" class="btn btn-secondary w-full" data-bs-dismiss="modal">No</button>
                            </div>
                            <div class="w-1/2 ml-1">
                                <button type="button" class="btn btn-danger w-full">Sì, elimina</button>
                            </div>
                        </div>
                    </div>
                </div>
